  ...
  return (
    <div className="bg-[#0b111a] border border-slate-800 rounded p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        <div className={`px-2 py-0.5 rounded border text-xs font-mono font-semibold flex items-center gap-1.5 ${snrStatus.bg} ${snrStatus.border} ${snrStatus.color}`}>
      ...
      <div className="space-y-1.5 mb-3">
        ...
        <div className="h-3 w-full bg-[#080d14] rounded overflow-hidden flex p-0.5 border border-slate-800">
          <div
      ...
      <div className="grid grid-cols-3 gap-2 p-3 bg-[#080d14] rounded border border-slate-800 text-xs">
        <div>
